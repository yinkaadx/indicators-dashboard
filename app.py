...
{
"User-Agent": "EconMirror/1.0 (+[https://yinkaadx.streamlit.app](https://yinkaadx.streamlit.app))",
...
"""
try:
url = "[https://cdn.cboe.com/api/global/delayed_quotes/options/totalpc.csv](https://cdn.cboe.com/api/global/delayed_quotes/options/totalpc.csv)"
...
"""
try:
url = "[https://www.aaii.com/files/surveys/sentiment.csv](https://www.aaii.com/files/surveys/sentiment.csv)"
df = pd.read_csv(url)
last = df.iloc[-1]
...
"[https://www.multpl.com/s-p-500-pe-ratio](https://www.multpl.com/s-p-500-pe-ratio)", timeout=15
).text
m = re.search(
...
"""
try:
url = "[http://openinsider.com/latest-insider-trading](http://openinsider.com/latest-insider-trading)"
...
"""
try:
url = "[https://www.policyuncertainty.com/media/US_GPR.csv](https://www.policyuncertainty.com/media/US_GPR.csv)"
df = pd.read_csv(url)
df["DATE"] = pd.to_datetime(
df["DATE"], format="%Y-%m-%d", errors="coerce"
)
...
"""
try:
url = "[https://www.bls.gov/news.release/prod2.nr0.htm](https://www.bls.gov/news.release/prod2.nr0.htm)"
resp = SESSION.get(url, timeout=20)
tables = pd.read_html(StringIO(resp.text))
...
CB_GOLD_FEEDS = [
"[https://www.gold.org/rss](https://www.gold.org/rss)",
"[https://news.gold.org/rss](https://news.gold.org/rss)",
]
